...
export default function App({ Component, pageProps, router }) {
  ...
  return (
    <>
      <Title suffix="Radash">{meta.metaTitle || meta.title}</Title>
      <Head>
        ...
        <meta
          key="twitter:image"
          name="twitter:image"
          content={`https://radash-docs.vercel.app${socialCardLarge}`}
        />
        <meta key="twitter:creator" name="twitter:creator" content="@repsofsunshine" />
        <meta
          key="og:url"
          property="og:url"
          content={`https://radash-docs.vercel.app${router.pathname}`}
        />
